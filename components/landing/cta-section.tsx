            ...
            <div className="flex items-center justify-between gap-8">
              <div className="max-w-2xl">
                <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight mb-6 text-background text-balance">
                  Cada formulario puede ser el inicio de un nuevo proceso.
                </h2>

                <p className="text-lg text-background/70 mb-8 leading-relaxed max-w-lg">
                  Crea experiencias personalizadas, centraliza la información y transforma respuestas en acciones para tu negocio.
                </p>
