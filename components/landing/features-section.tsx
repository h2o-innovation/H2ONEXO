...
const features = [
  {
    title: "Datos incompletos o desorganizados",
    description: "La información llega sin un estándar y dificulta el inicio de cada proceso.",
    animationKey: "neural" as const,
  },
  {
    title: "Retrabajo y errores de carga",
    description: "El equipo pierde tiempo corrigiendo datos en lugar de avanzar la operación.",
    animationKey: "workflow" as const,
  },
  {
    title: "Demoras para iniciar procesos",
    description: "La respuesta queda detenida hasta que alguien logra organizar la información.",
    animationKey: "security" as const,
  },
  {
    title: "Información en diferentes canales",
    description: "Los correos, planillas y mensajes dispersan el contexto de la operación.",
    animationKey: "analytics" as const,
  },
  {
    title: "Falta de trazabilidad",
    description: "Es difícil saber quién respondió y en qué etapa está el proceso.",
    animationKey: "globe" as const,
  },
  {
    title: "Dependencia del equipo técnico",
    description: "Cada nueva necesidad se convierte en una cola de desarrollo.",
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <p className="text-sm font-mono text-primary mb-3">// PROBLEMA</p>
            <h2
              className={`text-3xl lg:text-5xl font-semibold tracking-tight mb-6 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            >
              <span className="text-balance">Los distintos procesos aún</span>
              <br />
              <span className="text-balance">dependen de herramientas manuales.</span>
            </h2>
            <p
            ...
            >
              Las planillas, los mensajes y los documentos dispersos hacen que recopilar información sea lento, poco estandarizado y difícil de seguir.
            </p>
          </div>
